#include "../includes/stringbuilder.hpp"
#include "../includes/client.hpp"
#include "../lib/logger.hpp"

/* message class constructor begin */

StringBuilder::StringBuilder(Client* client, const std::string& message)
    : m_message(message),
...
StringBuilder::StringBuilder(const std::string& message)
    : m_message(message),
      m_valid_message(true),
      m_position(0)
{
...
Client&
    StringBuilder::get_from()
{
    return *_from;
}

const std::string&
    StringBuilder::get_message() const
{
    return m_message;
}

const std::string&
    StringBuilder::get_prefix() const
{
    return m_prefix;
}

const std::string&
    StringBuilder::get_command() const
{
    return m_command;
}

const std::vector<std::string>&
    StringBuilder::get_params() const
{
    return m_parameters;
}
...
const bool&
    StringBuilder::is_valid_message() const
{
...
std::string
    StringBuilder::reply_servername_prefix(std::string numeric_reply)
{
...
std::string
    StringBuilder::reply_nickmask_prefix(std::string command)
{
    std::string msg;
...
std::string
    StringBuilder::err_no_such_nick(const std::string& nickname)
{
...
std::string
    StringBuilder::err_no_such_channel(const std::string& channel_name)
{
...
std::string
    StringBuilder::err_too_many_channels(const std::string& channel_name)
{
...
std::string
    StringBuilder::err_too_many_targets(const std::string& target)
{
...
std::string
    StringBuilder::err_no_recipient()
{
...
std::string
    StringBuilder::err_no_text_to_send()
{
    return reply_servername_prefix("412") + " :No text to send\r\n";
}

std::string
    StringBuilder::err_unknown_command()
{
...
std::string
    StringBuilder::err_file_error(const std::string& file_op,
...
std::string
    StringBuilder::err_no_nickname_given()
{
    return reply_servername_prefix("431") + " :No nickname given\r\n";
}

std::string
    StringBuilder::err_erroneus_nickname(const std::string& nick)
{
...
std::string
    StringBuilder::err_nickname_in_use(const std::string& nick)
{
...
std::string
    StringBuilder::err_user_not_in_channel(const std::string& nick,
...
std::string
    StringBuilder::err_not_on_channel(const std::string& channel)
{
...
std::string
    StringBuilder::err_user_on_channel(const std::string& user,
                                       const std::string& channel)
{
...
std::string
    StringBuilder::err_not_registered()
{
    return reply_servername_prefix("451") + " :You have not registered\r\n";
}

std::string
    StringBuilder::err_need_more_params()
{
...
std::string
    StringBuilder::err_already_registred()
{
    return reply_servername_prefix("462") + " :You may not reregister\r\n";
}

std::string
    StringBuilder::err_passwd_mismatch()
{
    return reply_servername_prefix("464") + " :Password incorrect\r\n";
}

std::string
    StringBuilder::err_channel_is_full(const std::string& channel)
{
...
std::string
    StringBuilder::err_unknown_mode(const std::string& flag)
{
...
std::string
    StringBuilder::err_chanoprivs_needed(const std::string& channel)
{
...
std::string
    StringBuilder::err_u_mode_unknown_flag()
{
    return reply_servername_prefix("501") + " :Unknown MODE flag\r\n";
}

std::string
    StringBuilder::err_users_dont_match(const std::string& action)
{
...
std::string
    StringBuilder::rpl_list(const std::string  channel,
...
std::string
    StringBuilder::rpl_listend()
{
    return reply_servername_prefix("323") + " :End of LIST\r\n";
}

std::string
    StringBuilder::rpl_channel_mode_is(const std::string& channel)
{
    return reply_servername_prefix("324") + " " + channel + " +\r\n";
}

std::string
    StringBuilder::rpl_notopic(const std::string& channel)
{
...
std::string
    StringBuilder::rpl_topic(const std::string& channel,
                             const std::string& topic)
{
...
std::string
    StringBuilder::rpl_inviting(const std::string& nick,
                                const std::string& channel)
{
...
std::string
    StringBuilder::rpl_namreply(const std::string&             channel,
...
std::string
    StringBuilder::rpl_endofnames(const std::string& channel)
{
...
std::string
    StringBuilder::rpl_user_mode_is()
{
    return reply_servername_prefix("221") + " +\r\n";
}

std::string
    StringBuilder::rpl_welcome()
{
...
std::string
    StringBuilder::build_quit_reply(const std::string& reason)
{
    return reply_nickmask_prefix("QUIT") + " :" + reason + "\r\n";
}

std::string
    StringBuilder::build_part_reply(const std::string& channel)
{
    std::string param;
...
std::string
    StringBuilder::build_message_reply(const std::string& target)
{
...
std::string
    StringBuilder::build_invite_reply(const std::string& nick,
                                      const std::string& channel)
{
...
std::string
    StringBuilder::build_kick_reply(const std::string& channel,
...
std::string
    StringBuilder::build_nick_reply(const std::string& nick)
{
    return reply_nickmask_prefix(m_command) + " " + nick + "\r\n";
}

std::string
    StringBuilder::build_join_reply(const std::string& channel)
{
    return reply_nickmask_prefix(m_command) + " " + channel + "\r\n";
}

std::string
    StringBuilder::build_topic_reply()
{
